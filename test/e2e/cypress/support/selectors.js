...
export const MAP_LAYERS = {
  checkboxAfvalcontainers: '#Afvalcontainers',
  ...
  checkboxBelastingen: '#Belastingen',
  ...
  checkboxBodemkwaliteit: '#Bodemkwaliteit',
  ...
  checkboxGemeentelijkeBekendmakingen: `#${CSS.escape('Gemeentelijke bekendmakingen')}`,
  ...
  checkboxGeluidszones: '#Geluidszones',
  ...
  checkboxGrondexploitaties: '#Grondexploitaties',
  checkboxGrondEProjecten: '#grex-grex',
  checkboxHistorischeKaarten: `#${CSS.escape('Historische kaarten')}`,
  ...
  checkboxMilieuZonesVerkeer: `#${CSS.escape('Milieuzones verkeer')}`,
  ...
  checkboxRisicoZones: '#Risicozones',
  ...
  checkboxVeiligheidEnOverlast: `#${CSS.escape('Veiligheid en overlast')}`,
  ...
  checkboxWinkelgebieden: '#Winkelgebieden',
