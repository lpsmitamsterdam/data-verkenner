...
sizes.forEach((size) => {
  describe(`Homepage module, resolution is: ${size}`, () => {
    beforeEach(() => {
    ...
    it('Should check all menu items', () => {
      ...
      cy.checkMenuLink(menuSelector, 'Onderdelen', 'Data services', '/artikelen/artikel/services/')
    ...
    it('Should check all links in navigation block', () => {
      ...
      cy.checkNavigationBlock(HOMEPAGE.navigationBlockDataservices, '/artikelen/artikel/services/')
    })
