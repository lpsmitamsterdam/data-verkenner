...
import getVerblijfsobjectIdFromAddressQuery from './shared/utils/getVerblijfsobjectIdFromAddressQuery'
...
jest.mock('./matomo')
jest.mock('./shared/utils/getVerblijfsobjectIdFromAddressQuery')
