...
describe('getLoadingErrors', () => {
  it('should get the loading errors', () => {
    const ERROR_UNAUTHORIZED =
      { extensions: { code: 'UNAUTHORIZED' } } as GraphQLFormattedError<ErrorExtensions>
    const ERROR_DIFFERENT_CODE =
      { extensions: { code: 'FOO' } } as GraphQLFormattedError<ErrorExtensions>
