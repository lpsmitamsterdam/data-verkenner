// This file contains types from https://github.com/mike-north/json-typescript
...
export interface DocWithData<T extends PrimaryData = PrimaryData> extends DocBase {
...
export type PrimaryData<T extends string = string, A extends AttributesObject = AttributesObject> =
  | ResourceObject<T, A>
  | Array<ResourceObject<T, A>>
...
export type ResourceLinkage = null | never[] | ResourceIdentifierObject | ResourceIdentifierObject[]
