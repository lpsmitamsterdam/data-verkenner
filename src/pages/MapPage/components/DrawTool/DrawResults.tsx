...
import GeneralErrorAlert from '../../../../app/components/Alerts/GeneralErrorAlert'
import { useDataSelection } from '../../../../app/contexts/DataSelection/DataSelectionContext'
import DataSelectionActiveFilters from '../../../../app/components/DataSelection/DataSelectionActiveFilters'
import { createFiltersObject } from '../../../../app/utils/dataSelection/normalizations'
import useAsyncMapPanelHeader from '../../utils/useAsyncMapPanelHeader'
import { AuthError, ForbiddenError } from '../../../../app/utils/api/customError'
